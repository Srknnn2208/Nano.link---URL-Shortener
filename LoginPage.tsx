        ...
        <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-black text-white font-mono">
            <div className="max-w-md w-full space-y-8 z-10">
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    ...
                    {suggestion && (
                        <div className="text-center">
                            <Link to="/register" className="text-neon-green hover:underline text-sm font-bold animate-pulse">
                    ...
                    <div>
                        ...
                        >
                            <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                                <Lock className="h-5 w-5 text-black/50 group-hover:text-black" />
                            </span>
                            AUTHENTICATE
                        </button>
                    </div>
                    <div className="text-center text-sm">
                        <Link to="/register" className="text-gray-500 hover:text-neon-green transition-colors">
                            NEW_USER? <span className="underline">REGISTER</span>
                        </Link>
                    </div>
                </form>
            </div>
